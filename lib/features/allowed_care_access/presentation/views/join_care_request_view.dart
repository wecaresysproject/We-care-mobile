...
import 'package:we_care/features/allowed_care_access/presentation/views/widgets/search_result_list_bloc_builder.dart';
...
class JoinCareRequestScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<AccessManagementCubit, AccessManagementState>(
      listenWhen: (previous, current) =>
          previous.createRequestStatus != current.createRequestStatus,
      listener: (context, state) {
        if (state.createRequestStatus == RequestStatus.success) {
          showSuccess(state.createRequestMessage);
          Navigator.of(context).pop();
        } else if (state.createRequestStatus == RequestStatus.failure) {
          showError(state.createRequestMessage);
        }
      },
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SearchResultListBlocBuilder(),
