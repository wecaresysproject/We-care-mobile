...
class MedicalReportRepo {
  ...
  Future<ApiResult<MedicalReportFilterResponseModel>> getSupplementsFilters(
    String language,
    String userType,
  ) async {
    try {
      final response = await _apiServices.getSupplementsFilters(
        language,
        userType,
      );
      return ApiResult.success(
  ...
  Future<ApiResult<MedicalReportFilterResponseModel>> getMentalDiseasesFilters(
    String language,
    String userType,
  ) async {
    try {
