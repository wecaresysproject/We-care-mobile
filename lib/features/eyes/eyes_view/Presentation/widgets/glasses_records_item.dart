...
class GlassesRecordItem extends StatelessWidget {
  final EyeGlassesRecordModel item;
  final VoidCallback? onArrowTap;

  const GlassesRecordItem({
    super.key,
    required this.item,
    this.onArrowTap,
  });
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            "العين اليمني قصر/طول النظر:",
                            style: AppTextStyles.font14BlueWeight700
                                .copyWith(fontSize: 14.sp),
                          ),
                          SizedBox(width: 8.w),
                          Text(
                            item.rightEyeSphericalPower,
                            style: AppTextStyles.font14blackWeight400
                                .copyWith(fontSize: 14.sp),
                          ),
                        ],
                      ...
                      Row(
                        children: [
                          Text(
                            "العين اليسري قصر/طول النظر:",
                            style: AppTextStyles.font14BlueWeight700
                                .copyWith(fontSize: 14.sp),
                          ),
                          SizedBox(width: 8.w),
                          Text(
                            item.leftEyeSphericalPower,
                            style: AppTextStyles.font14blackWeight400
                                .copyWith(fontSize: 14.sp),
                          ),
                        ],
