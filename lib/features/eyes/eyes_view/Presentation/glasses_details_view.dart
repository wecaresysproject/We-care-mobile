                  ...
                  Row(
                    ...
                    children: [
                      LensDetailsCard(
                        ...
                        lensData: {
                          "قصر النظر": data.rightEye.nearsightedness,
                          "طول القصر": data.rightEye.farsightedness,
                          "الاستجماتزم": data.rightEye.cylinder,
                          "محور الاستجماتزم": data.rightEye.cylinderAxis,
                          "الإضافة البؤرية": data.rightEye.addition,
                          "تباعُد الحدقتين": data.rightEye.bifocalSegment,
                          "معامل الانكسار": data.rightEye.refractionCoefficient,
                          "قطر العدسة": data.rightEye.lensDiameter,
                          "المركز": data.rightEye.center,
                          "الحواف": data.rightEye.edges,
                          "سطح العدسة": data.rightEye.lensSurface,
                      ...
                      LensDetailsCard(
                        ...
                        lensData: {
                          "قصر النظر": data.leftEye.nearsightedness,
                          "طول القصر": data.leftEye.farsightedness,
                          "الاستجماتزم": data.leftEye.cylinder,
                          "محور الاستجماتزم": data.leftEye.cylinderAxis,
                          "الإضافة البؤرية": data.leftEye.addition,
                          "تباعُد الحدقتين": data.leftEye.bifocalSegment,
                          "معامل الانكسار": data.leftEye.refractionCoefficient,
                          "قطر العدسة": data.leftEye.lensDiameter,
                          "المركز": data.leftEye.center,
                          "الحواف": data.leftEye.edges,
                          "سطح العدسة": data.leftEye.lensSurface,
