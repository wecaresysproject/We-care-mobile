...
class AddNewMedicationView extends StatelessWidget {
  const AddNewMedicationView({
    super.key,
    this.editingMedicineDetailsData,
    this.medicineId,
  });
  final AddNewMedicineModel? editingMedicineDetailsData;
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        ...
        if (editingMedicineDetailsData == null) {
          cubit.initialDataEntryRequests();
        } else {
          cubit.loadMedicineDetailsViewForEditing(editingMedicineDetailsData!);
        }
        return cubit;
      },
              ...
              child: Column(
                ...
                children: [
                  ...
                  DateTimePickerContainer(
                    ...
                    placeholderText:
                        state.medicineStartDate ?? "يوم / شهر / سنة",
                  ...
                  verticalSpacing(16),
                  BlocListener<MedicinesDataEntryCubit,
                    ...
                    child: AppCustomButton(
                      title: state.isEditingAddedMedicine
                          ? "تَعديلُ مَعْلوماتِ الدواء"
                          : "اضافة دواء جديد",
                      onPressed: () async {
                        if (state.isAddNewMedicineFormValidated) {
                          state.isEditingAddedMedicine
                              ? await context
                                  .read<MedicinesDataEntryCubit>()
                                  .updateAddedMedicine(
                                    medicineId!,
