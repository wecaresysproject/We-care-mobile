...
class RiskyBehaviorsViewAppBar extends StatelessWidget {
  const RiskyBehaviorsViewAppBar({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<RiskyBehaviorsViewCubit, RiskyBehaviorsViewState>(
